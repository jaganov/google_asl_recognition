...
def analyze_signs_distribution(df, sign_mapping):
    ...
    print(f"   Среднее количество записей на знак: {sign_counts.mean():.1}")
    print(f"   Медиана записей на знак: {sign_counts.median():.1}")
    print(f"   Минимум записей на знак: {sign_counts.min()}")
    print(f"   Максимум записей на знак: {sign_counts.max()}")
